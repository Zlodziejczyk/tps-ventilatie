...
- [x] 07-04-PLAN.md — Touch targets ≥44px: sticky-bar close, mobile-menu chevrons, review-carousel arrows (A11Y-04) [wave 1]
- [x] 07-11-PLAN.md — Cleanup: delete the 5 retired Phase-6 homepage section files (HeroSection/ServicesSection/PricingSection/WhyTPSSection/ReviewsSection — zero importers) [wave 1]
...
- [x] 07-12-PLAN.md — Footer brand refresh: PNG logo + 4-pillar copy + live-taxonomy Diensten links + drop 1px border (IG/FB icons deferred, owner-blocked) (UI-11) [wave 2]
...
- [x] 07-07-PLAN.md — Live homepage hero verify-and-record (HomeHero + globals.css): Dutch badge, calm teal CSS aurora, clean 375px — retargeted off the dead HeroSection (UI-05, UI-06, UI-07) [wave 3]
- [x] 07-09-PLAN.md — "Nieuw" badge font ≥11px: Navbar, MobileMenu, diensten hub (UI-12) [wave 3]
