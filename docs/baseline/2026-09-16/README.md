...
| `gsc/performance-tpsklimaattechniek.nl-by-query.json` | Search-Analytics-export nieuw domein **per query**, 2026-08-12 → 2026-09-16 (D-16): **0 rijen** op dag één na verificatie — een tijdstip-uitspraak, geen bug (RESEARCH Pitfall 9); 09-06 trekt opnieuw ≥ 72 h na verificatie | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsklimaattechniek.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsklimaattechniek.nl-by-query.csv` | Dezelfde export per query als CSV (alleen de kopregel `query,clicks,impressions,ctr,position` — 0 rijen) | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsklimaattechniek.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsklimaattechniek.nl-by-page.json` | Search-Analytics-export nieuw domein **per pagina**, 2026-08-12 → 2026-09-16: **0 rijen** (zie de query-export) | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsklimaattechniek.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsklimaattechniek.nl-by-page.csv` | Dezelfde export per pagina als CSV (alleen de kopregel — 0 rijen) | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsklimaattechniek.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsventilatie.nl-by-query.json` | Search-Analytics-export legacy-domein **per query**, 16 maanden (2025-05-19 → 2026-09-16): **0 rijen** — de Domain-property is pas op 2026-09-16 geverifieerd, de historie verschijnt met vertraging; 09-06 trekt opnieuw | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsventilatie.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsventilatie.nl-by-query.csv` | Dezelfde export per query als CSV (alleen de kopregel — 0 rijen) | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsventilatie.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsventilatie.nl-by-page.json` | Search-Analytics-export legacy-domein **per pagina**, 2025-05-19 → 2026-09-16: **0 rijen** (zie de query-export) | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsventilatie.nl --out docs/baseline/<datum>/gsc` |
| `gsc/performance-tpsventilatie.nl-by-page.csv` | Dezelfde export per pagina als CSV (alleen de kopregel — 0 rijen) | 2026-09-17T08:24:03Z | Search Console API `searchAnalytics.query` (`dataState: final`) | `npx tsx scripts/export-gsc-performance.ts --property sc-domain:tpsventilatie.nl --out docs/baseline/<datum>/gsc` |
