...
| `serp/serp-baseline.md` | Geolokaliseerde SERP-nulmeting (D-13): 24 queries × 2 domeinen, positie in de top 20 of `niet in top 20`, local-pack-kolom; **23/24 vastgelegd op 2026-09-17** (Google gaf tweemaal een 403 — de nog ontbrekende rij q24 `tps ventilatie` staat expliciet als `niet vastgelegd` en wordt aangevuld) | 2026-09-17T09:00Z–11:33Z (zie `taken:` in het bestand) | Chrome (google.nl, `pws=0`, `uule` Zoetermeer) | de methode-sectie in het bestand: zelfde URL-template, zelfde `uule`, footer-controle, p.1 + p.2 |
