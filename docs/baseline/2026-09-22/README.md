...
| `owner/mig-04-owner-confirmation.md` | Waarom D-22's tweede helft is komen te vervallen: MIG-04's doelzin is inspecteerbaarheid van het terugdraaidoel, en terugdraaien is twee A-records — niemand logt in WordPress in om dat te doen, dus de inloggegevens stonden nooit op dat pad. MIG-04 is groen op de mechanische helft alleen | 2026-09-22 | besluit eigenaar (geen eigenaarspoorten) | n.v.t. (besluitdocument) |
| `owner/mail-cert-question.md` | Waarom de certificaatvraag aan cyberfolks **bewust niet** is gesteld: `info@tpsventilatie.nl` blijkt niet in gebruik (eigenaar, 2026-09-22), dus het verlopen op 2026-10-29 is geaccepteerd. Bevat wel de gemeten certificaatfeiten en het restrisico dat wél blijft — het abonnement dat de WordPress-installatie in leven houdt | 2026-09-22 | besluit eigenaar + `openssl s_client` | n.v.t. (besluitdocument) |
| `owner/footer-copy-choice.md` | De gekozen footerregel (register **B**: *TPS klimaattechniek is de nieuwe naam van TPS Ventilatie.*), wie de redactionele poort vervulde (Pushly.nl, niet de klant) en waarom A en C afvielen | 2026-09-22 | besluit bureau | n.v.t. (besluitdocument; de string zit in `components/Footer.tsx` via `SITE.formerName`) |
