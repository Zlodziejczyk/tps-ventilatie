...
| `owner/mig-04-owner-confirmation.md` | De **menselijke** helft van MIG-04: Thomas die één keer daadwerkelijk inlogt via de hosts-omleiding. Samen met `mig-04-mechanical.md` maakt dit de poort compleet — een bewijs dat alleen de route test is half waar (D-22) | gevraagd 2026-09-22 | bericht aan Thomas | n.v.t. (bevestiging van een mens; **blokkerend** voor plan 10-07) |
...
| `owner/footer-copy-choice.md` | Welke van de drie Nederlandse registers de eigenaar kiest voor de permanente footerregel (D-26), met de preview-URL waarop register B gerenderd staat | gevraagd 2026-09-22 | bericht aan Thomas | n.v.t. (redactionele keuze; niet blokkerend — B is de standaard) |
